...
class __PageStateListState extends State<_ListPage> {
  ...
  List<String> subTitle = [
    "Makanan enak yg disantap saat malam atau pagi hari",
  ...
  List<String> Bahan = [
    "Nasi + Telur + Kecap Manis + Cabai & Bawang + Dll ",
  ...
  List<String> caraMembuat = [
    "Masukan nasi dan telur, lalu campurkan dengan kecap dan bumbu penyedap jika sudah tunggu hingga masakan terlihat matang.",
